...
if (window.location.pathname.includes('explore-courses.html')) {
    ...
    // ... define other filter elements if needed ...

    // --- Function to Create a Single Course Card ---
    const createCourseCard = (course) => {
        const API_BASE_URL = 'http://54.221.189.159'; // Ensure this is available
        let priceHtml = '';
        ...
        const lessonCount = course.episodes ? course.episodes.reduce((acc, ep) => acc + (ep.lessons ? ep.lessons.length : 0), 0) : 0;
        
        // **FIX #1: Corrected data-course-id syntax**
        return `
                ...
                <div class="rbt-card variation-01 rbt-hover">
                    ...
                    <div class="rbt-card-body">
                        ...
                        <div class="rbt-author-meta mb--10">
                            ...
                            <div class="rbt-author-info">By <a href="#">${instructorName}</a></div>
                        </div>
                        <div class="rbt-card-bottom">
                            ${priceHtml}
        ...
        try {
            ...
            if (data.success) {
                ...
                if (data.courses.length > 0) {
                    ...
                    courseListContainer.innerHTML = '<div class="col-12 text-center"><p>No courses found.</p></div>';
                }
    ...
    if (courseListContainer) {
        courseListContainer.addEventListener('click', async (e) => {
            ...
            // **FIX #2: Corrected selector to find the parent with the ID**
